...
import p from "../assets/shivam.jpeg";

export default function About() {
  const states = [
    { label: "Experience", value: "Fresher" },
    { label: "Speciality", value: "FullStack and Data Science" },
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          {/* Profile Image */}
          <motion.div
            className="relative w-[160px] h-[160px] md:w-[200px] md:h-[200px] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#1cd8d2]/20 to-[#302b63]/20 border border-[#1cd8d2]/20"
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-2 text-lg sm:text-xl text-white/90 font-semibold">
              Student at PGMCOE College, Pune
            </p>

            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              Motivated and dedicated B.Tech student at PGMCOE Institute of Information Technology, Pune, with a strong foundation in
              engineering concepts, programming, and problem-solving. Skilled in
              applying theoretical knowledge to practical projects, with
              interest in software development, databases, and emerging
              technologies.
            </p>
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
            I'm a Data Science and Web Developer
            passionate about building fast, resilient applications and studying new technologys related AI .
          </p>
