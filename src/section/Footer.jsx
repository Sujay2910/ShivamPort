...
const socials = [
  ...
  { Icon: FaLinkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/shivam-bhosale-104913271/" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/BhosaleShiv" },
  { Icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/shivam_bhosale_7415" },
];
      ...
      >
        ...
        <p className="text-gray-300 italic max-w-xl">
          ...
          <p className="text-xs text-gray-100">
            &copy; {new Date().getFullYear()} Shivam Bhosale. All rights reserved.
          </p>
      </motion.div>
    </footer>
  );
